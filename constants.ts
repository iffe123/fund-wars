...
import type { PlayerStats, Scenario, NewsEvent, DifficultySettings, Difficulty, LifeAction, StructureChoice, DueDiligencePhase, PortfolioAction, PortfolioCompany, FinancingPhase, NPC, QuizQuestion, MarketVolatility } from './types';
