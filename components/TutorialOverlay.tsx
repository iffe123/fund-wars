...
const TutorialOverlay: React.FC<TutorialOverlayProps> = ({ instruction, step }) => {
  ...
  const pointerClass = isBottomHeavyStep 
    ? "border-b-[10px] border-b-transparent border-t-[10px] border-t-amber-500" // Point Down
    : "border-t-[10px] border-t-transparent border-b-[10px] border-b-amber-500"; // Point Up
