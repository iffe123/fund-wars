...
const BoardBattleModal: React.FC<BoardBattleModalProps> = ({ companyName, ceoName, onClose, onResolve }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/90 flex items-center justify-center p-4 font-mono" style={{ zIndex: Z_INDEX.modal }} role="dialog" aria-modal="true" aria-label="Emergency Board Meeting">
